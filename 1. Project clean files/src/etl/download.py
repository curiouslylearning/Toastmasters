...
def build_url(program_year: str, district_code: str, month_end: str, asof_date: str) -> str:
...
def download_from_df(df: pd.DataFrame, out_dir: str) -> pd.DataFrame:
    """
    ...
    for i, row in df.reset_index(drop=True).iterrows():
        ...
        #bygger URLen
        url = build_url(program_year, district_code, month_end, asof_date)
