...
#For sorting the TM months. A TM year starts in June
MONTH_MAP_FISCAL = {
...
def fiscal_month(df: pd.DataFrame):
    #Needed for correct sorting. Creates an integer column in df

    df["Month_Num_Fiscal"] = df["MonthOf"].map(MONTH_MAP_FISCAL)
