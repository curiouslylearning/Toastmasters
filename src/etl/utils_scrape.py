...
def get_years_from_page(url: str):
...
def get_months_from_page(url: str):
    #URL = "https://dashboards.toastmasters.org/Club.aspx?id=01"
    #URL = "https://dashboards.toastmasters.org/District.aspx?id=01"
    headers = {"User-Agent": "Mozilla/5.0"}
...
def get_districts_from_page(org_level_short, year, month, district_id="01"):
    #url = f"https://dashboards.toastmasters.org/{year}/Club.aspx?id={district_id}&month={month}"
    url = f"https://dashboards.toastmasters.org/{year}/{org_level_short}.aspx?id={district_id}&month={month}"
